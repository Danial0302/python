...
image_background = pygame.image.load(str(BASE_DIR / 'AnimatedStreet.png'))
image_player = pygame.image.load(str(BASE_DIR / 'Player.png'))
image_enemy = pygame.image.load(str(BASE_DIR / 'Enemy.png'))
coin_image = pygame.image.load(str(BASE_DIR / 'dollar.png')).convert_alpha()

collected = 0

pygame.mixer.music.load(str(BASE_DIR / 'background.wav'))
pygame.mixer.music.play(-1)

sound_crash = pygame.mixer.Sound(str(BASE_DIR / 'crash.wav'))
